        ...
        <div className="m-[48px]">
            ...
            <div className="space-y-[24px]">
                <div className="flex flex-col space-y-[24px] md:flex-row md:justify-between">
                    <div className="flex flex-col items-center sm:flex-row sm:gap-[8px] md:gap-[12px]">
                        <label className="font-['Epilogue'] text-[24px] font-bold">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                    <div>
                        <h3 className="font-bold text-gray-700">Start Time</h3>
                        <p>{format(new Date(event.startTime), 'h:mm a')}</p>
                    </div>

                    <div>
                        <h3 className="font-bold text-gray-700">End Time</h3>
                        <p>
                            {event.endTime &&
