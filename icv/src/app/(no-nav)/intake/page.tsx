                            ...
                            {showConfirmClear ? (
                                <div className="flex flex-col space-y-[12px]">
                                    <span className="text-sm text-neutral-600">
                                        Are you sure?{' '}
                                        <strong>
                                            All progress across pages will be
                                            lost.
                                        </strong>
                                    </span>
                                    <div className="flex flex-row space-x-[16px]">
                                        ...
                                        <button
                                            ...
                                            className="h-[52px] w-[200px] rounded-[5px] bg-[#FF394D] px-4 py-2 text-white"
                                        >
                                            Yes, clear
                                        </button>
                                    </div>
                                ...
                                <button
                                    ...
                                    className="text-sm text-[#FF394D] underline hover:text-neutral-300"
                                >
                                    Clear Form
                                </button>
                            )}
